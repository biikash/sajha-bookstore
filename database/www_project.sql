...
INSERT INTO `bookstore`.`admin` (`name`, `pass`) VALUES
...
INSERT INTO `bookstore`.`books` (`book_isbn`, `book_title`, `book_author`, `book_image`, `book_descr`, `book_price`, `publisherid`) VALUES
...
INSERT INTO `bookstore`.`customers` (`customerid`, `name`, `address`, `city`, `zip_code`, `country`) VALUES
(1, 'a', 'a', 'a', 'a', 'a'),
(2, 'b', 'b', 'b', 'b', 'b'),
...
INSERT INTO `bookstore`.`orders` (`orderid`, `customerid`, `amount`, `date`, `ship_name`, `ship_address`, `ship_city`, `ship_zip_code`, `ship_country`) VALUES
...
INSERT INTO `bookstore`.`order_items` (`orderid`, `book_isbn`, `item_price`, `quantity`) VALUES
...
INSERT INTO `bookstore`.`publisher` (`publisherid`, `publisher_name`) VALUES
(1, 'Wrox'),
(2, 'Wiley'),
(3, 'O''Reilly Media'),
(4, 'Apress'),
